...
btn_seno.cria_botao(lambda: seno())

btn_cosseno = Botao('Cos', 1, 1)
btn_cosseno.cria_botao(lambda: cosseno())

btn_tangente = Botao('Tan', 1, 2)
btn_tangente.cria_botao(lambda: tangente())

btn_raiz_nesima = Botao('x^1/n', 1, 3)
btn_raiz_nesima.cria_botao(lambda: raiz_nesima())

btn_raiz_quadrada = Botao('x^1/2', 2, 4)
btn_raiz_quadrada.cria_botao(lambda: raiz_quadrada())

btn_limpar = Botao('C', 1, 4)
btn_limpar.cria_botao(lambda: limpa_visor(resultado_na_tela))

btn_potencia = Botao('x^n', 3, 4)
btn_potencia.cria_botao(lambda: exponenciacao())
...
btn_divisao.cria_botao(lambda: divisao())

btn_multiplicacao = Botao('*', 3, 3)
btn_multiplicacao.cria_botao(lambda: multiplicacao())
...
btn_subtracao.cria_botao(lambda: subtracao())
